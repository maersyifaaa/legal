    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-amber-600">
            <a href="/home" class="flex items-center pl-2.5 mb-5">
                <img src="images/logo.png" class="h-10" alt="legal logo" />
            ...
            <div class="flex items-center justify-center my-8">
                <div class="items-center justify-center w-full">
                    <img class="w-1/2 rounded-full mb-2 ml-14"
                        ...
                        alt="profil user">
                    <p class="text-center text-zinc-800 font-extrabold">Firda Kusuma Wardani</p>
                </div>
            </div>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="/home"
                        class="flex items-center p-2 my-6 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-5 h-5 text-black-500 transition duration-75 dark:text-black-400 group-hover:text-black-200 dark:group-hover:text-white"
         ...
         <p class="text-2xl text-gray-400 dark:text-gray-500">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($pelaporanhukum as $index => $pelaporanhukum)
