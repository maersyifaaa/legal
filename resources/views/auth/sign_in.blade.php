    ...
    <div class="bg-gradient-to-b from-amber-600 min-h-screen flex items-center">
        <div class="flex-1 max-w-full mx-auto min-h-screen flex">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="container max-w-md bg-white shadow-xl m-auto p-10 rounded-xl">
                    ...
                    <form action="" class="flex flex-col gap-4">
                        ...
                        <a href="/home" type="submit" class="text-white bg-amber-600 focus:ring-4 focus:outline-none focus:ring-white-300 w-1/2 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 
    text-center dark:bg-white-600 dark:hover:bg-amber-500 dark:focus:ring-black-800">Sign in
                        </a>
                    </form>
                    ...
                    <div class="mt-5 text-xs py-4 text-black">
