...
<body>
  <div class="w-[1440px] h-[1024px] relative bg-white">
    ...
    <div class="h-[75px] left-[273px] top-[100px] absolute">
      <div class="w-[274px] h-[75px] left-[1px] top-0 absolute text-zinc-800 text-4xl font-extrabold font-['Poppins']">Surat Keluar</div>
    </div>
    <div class="w-[92px] h-[50px] left-[274px] top-[633px] absolute">
      ...
      <button type="submit" class="w-[52px] left-[20px] top-[13px] absolute text-center text-orange-100 text-base font-normal font-['Inter'] leading-normal">submit</button>
    </div>
    <div class="w-[391px] h-[100px] left-[817px] top-[478px] absolute">
      <div class="w-[391px] h-[50px] left-0 top-[50px] absolute">
        ...
        <input type="text" class="w-[391px] h-[50px] left-0 top-0 absolute rounded-lg border border-zinc-200" "text-zinc-500 text-base font-normal font-['Inter'] leading-normal" placeholder="Enter Text Here..."></div>
    ...
    <div class="w-[391px] h-[100px] left-[274px] top-[478px] absolute">
      <div class="w-[391px] h-[50px] left-0 top-[50px] absolute">
        <div class="w-[391px] h-[50px] left-0 top-0 absolute rounded-lg border border-zinc-200"></div>
        <input type="text" class="w-[391px] h-[50px] left-0 top-0 absolute rounded-lg border border-zinc-200" "text-zinc-500 text-base font-normal font-['Inter'] leading-normal" placeholder="Enter Text Here..."></div>
      <div class="w-[350px] h-[50px] left-0 top-0 absolute text-slate-500 text-xl font-semibold font-['Poppins']">Nomor Surat</div>
    </div>
    <div class="w-[391px] h-[100px] left-[274px] top-[345px] absolute">
      <div class="w-[391px] h-[50px] left-0 top-[50px] absolute">
        <div class="w-[391px] h-[50px] left-0 top-0 absolute rounded-lg border border-zinc-200"></div>
        <input type="text" class="w-[391px] h-[50px] left-0 top-0 absolute rounded-lg border border-zinc-200" "text-zinc-500 text-base font-normal font-['Inter'] leading-normal" placeholder="Enter Text Here..."></div>
      <div class="w-[350px] h-[50px] left-0 top-0 absolute text-slate-500 text-xl font-semibold font-['Poppins']">Judul Surat</div>
    </div>
    <div id="Forms" class="h-[100px] left-[274px] top-[212px] absolute">
      <div class="w-[391px] h-[50px] left-0 top-[50px] absolute">
        <input type="text" class="w-[391px] h-[50px] left-0 top-0 absolute rounded-lg border border-zinc-200" "text-zinc-500 text-base font-normal font-['Inter'] leading-normal" placeholder="Enter Text Here..."></div>
      <div class="w-[350px] h-[50px] left-0 top-100 absolute text-slate-500 text-xl font-semibold font-['Poppins']">Nama Instansi</div>
    </div>
  </div>
</body>
