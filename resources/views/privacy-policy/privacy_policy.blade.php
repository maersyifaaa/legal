        ...
        <div class="p-4 border-2 border-white">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="flex py-8 h-24 rounded bg-gray-50 dark:bg-clear-400">
                    <p class="w-5.5 h-3.5 text-zinc-800 text-4xl font-extrabold font-['Poppins']">
                        Privacy Policy
                    </p>
                </div>
         ...
         <p class="text-2xl text-gray-400 dark:text-gray-500">
            ...
            <div>
        <a href="#" class="block w-3/4 p-6 bg-white border border-amber-600 rounded-lg shadow hover:bg-amber-100 dark:bg-white-800 dark:border-white-700 dark:hover:bg-amber-600">
